...
<script>
    ...
    <div style="background:#004B87;flex-grow:1;display:flex;justify-content:center;align-items:center;padding:0 25px;box-sizing:border-box;">
        <span style="font-family:Barlow,sans-serif;font-size:35px;font-weight:bold;color:#fff;text-transform:uppercase; transform:translateY(-17px);">
            GRAPHIC DESIGNS
        </span>
    </div>`;
